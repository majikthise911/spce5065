---
name: feedback_submission_voice
description: Where to find the canonical submission-voice anchor for SPCE 5065 (use sibling courses)
metadata: 
  node_type: memory
  type: feedback
  originSessionId: a7c1325b-be48-4059-83fc-0a17d4f2823c
---
...
**How to apply:** Before drafting, skim one recent 5025 (math) and one recent 5045 (conceptual) submission to re-anchor, then write 5065 work in that same voice. If a 5065 graded submission later lands that nails it, record it here as the in-course anchor. Related: [[project_hw1_pipeline]].

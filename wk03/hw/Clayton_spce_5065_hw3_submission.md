...
A typical astronaut cycles about 5 kg/day in and out, roughly 3.5 kg of it potable water [3]. Two requirements that free fall specifically drives:
...
**Beyond the two requirements, one idea worth flagging.** The calcium problem is really about *where* the calcium goes, not just how much you have, and that is where vitamin K2 gets interesting. K2 switches on two proteins that route calcium: osteocalcin, which locks it into the bone matrix, and matrix Gla protein, which keeps it out of artery walls and soft tissue [6]. In free fall that is exactly the failure mode: bone is dumping calcium into blood and urine, vitamin D is pushing gut absorption up, and two of the roadmap's red risks (renal stones, and separately the arterial stiffening astronauts show) are both "calcium in the wrong place." So pairing K2 with the vitamin D and calcium is at least a plausible way to steer the mobilized calcium back into bone instead of kidneys and vessels. It is not an established countermeasure and the flight evidence is thin, but spaceflight-nutrition work has already flagged undercarboxylated (functionally low-K) osteocalcin in crews [5], which is the exact signature K2 would correct. Worth a look for a future crew.
...
**Rationale.**
- **(a) Outbound, 20 m³:** right at optimal. Half a year of 0 g with no outside and a crew still forming, so I start them at optimal, not the "performance" tier [3], [7]. Skimping here reappears later as a crew-cohesion problem.
- **(b) Surface, 25 m³:** above optimal because it is the longest and busiest phase (EVA prep, samples, science on top of daily living), so people need workspace too. The 0.38 g restores up/down and makes the extra volume cheap to build with landed or inflatable habitats [7].
...
Private crew quarters are the concrete form of this volume and a Liveware-Liveware mitigation, not a luxury [3]. Below ~10 m³ you are in the degrading "performance" band, and 5 m³ is bare survival [3], [7]; nothing about a two-plus-year mission belongs there.
...
**Assumptions:** Ceres sits at 2.77 AU, so a crewed mission is a multi-year round trip, surface gravity is only ~0.029 g (essentially still free fall), and comm delay runs up to ~30 min one way [3], [8]. Those three facts (longer, more radiation, weaker gravity) drive the ratings up.
...
**Table 2:** Roadmap ratings, Mars (per NASA) and Ceres (mine). Cells are colored by rating: red = no mitigation, yellow = partial mitigation, green = well mitigated.

<style>
table.roadmap { border-collapse: collapse; font-size: 0.92em; }
table.roadmap th, table.roadmap td { border: 1px solid #888; padding: 4px 8px; }
table.roadmap th { background-color: #f1f3f5; }
td.R { background-color: #e03131; color: #fff; text-align: center; font-weight: bold; }
td.Y { background-color: #f2c000; color: #000; text-align: center; font-weight: bold; }
td.G { background-color: #2f9e44; color: #fff; text-align: center; font-weight: bold; }
td.NA { background-color: #dee2e6; color: #495057; text-align: center; }
</style>

<table class="roadmap">
<thead>
<tr><th style="text-align:left">Risk</th><th>Mars op.</th><th>Mars long</th><th>Ceres op.</th><th>Ceres long</th></tr>
</thead>
<tbody>
<tr><td>Adverse Cognitive/Behavioral Conditions &amp; Psychiatric Disorders</td><td class="R">R</td><td class="Y">Y</td><td class="R">R</td><td class="R">R</td></tr>
<tr><td>Adverse Health/Performance Effects of Celestial Dust Exposure</td><td class="R">R</td><td class="R">R</td><td class="Y">Y</td><td class="Y">Y</td></tr>
<tr><td>Adverse Health Effects Due to Host-Microorganism Interactions</td><td class="Y">Y</td><td class="Y">Y</td><td class="R">R</td><td class="R">R</td></tr>
<tr><td>Adverse Health Event Due to Altered Immune Response</td><td class="Y">Y</td><td class="Y">Y</td><td class="R">R</td><td class="R">R</td></tr>
<tr><td>Adverse Health Outcomes from Medical Conditions (in-mission &amp; long-term)</td><td class="R">R</td><td class="R">R</td><td class="R">R</td><td class="R">R</td></tr>
<tr><td>Adverse Outcomes from Inadequate Human Systems Integration</td><td class="R">R</td><td class="NA">N/A</td><td class="R">R</td><td class="NA">N/A</td></tr>
<tr><td>Altered Sensorimotor/Vestibular Function</td><td class="Y">Y</td><td class="G">G</td><td class="R">R</td><td class="Y">Y</td></tr>
<tr><td>Bone Fracture from Spaceflight-Induced Bone Changes</td><td class="R">R</td><td class="Y">Y</td><td class="R">R</td><td class="R">R</td></tr>
<tr><td>Cardiovascular Adaptations</td><td class="R">R</td><td class="Y">Y</td><td class="R">R</td><td class="R">R</td></tr>
<tr><td>Reduced Muscle Size, Strength, Endurance</td><td class="Y">Y</td><td class="G">G</td><td class="R">R</td><td class="Y">Y</td></tr>
<tr><td>Ineffective or Toxic Medications</td><td class="R">R</td><td class="R">R</td><td class="R">R</td><td class="R">R</td></tr>
<tr><td>Injury &amp; Compromised Performance from EVA Operations</td><td class="R">R</td><td class="Y">Y</td><td class="R">R</td><td class="R">R</td></tr>
<tr><td>Injury from Dynamic Loads</td><td class="R">R</td><td class="NA">N/A</td><td class="Y">Y</td><td class="NA">N/A</td></tr>
<tr><td>Behavioral Health Decrements from Inadequate Team Cooperation</td><td class="R">R</td><td class="NA">N/A</td><td class="R">R</td><td class="NA">N/A</td></tr>
<tr><td>Crew Illness from Inadequate Food and Nutrition</td><td class="R">R</td><td class="R">R</td><td class="R">R</td><td class="R">R</td></tr>
<tr><td>Sleep Loss, Circadian Desynchronization, Work Overload</td><td class="Y">Y</td><td class="Y">Y</td><td class="R">R</td><td class="R">R</td></tr>
<tr><td>Radiation Carcinogenesis</td><td class="G">G</td><td class="Y">Y</td><td class="R">R</td><td class="R">R</td></tr>
<tr><td>Reduced Aerobic Capacity</td><td class="Y">Y</td><td class="G">G</td><td class="R">R</td><td class="Y">Y</td></tr>
<tr><td>Renal Stone Formation</td><td class="R">R</td><td class="R">R</td><td class="R">R</td><td class="R">R</td></tr>
<tr><td>Spaceflight-Associated Neuro-ocular Syndrome (SANS)</td><td class="R">R</td><td class="R">R</td><td class="R">R</td><td class="R">R</td></tr>
</tbody>
</table>

The pattern: Ceres pushes most risks toward red, because exposures accumulate over the longer mission, cumulative radiation climbs, and the ~0.03 g surface gives none of the reloading that lets several Mars risks sit green long-term [3], [4], [8]. Two risks actually ease off, and they are worth calling out because they show it is the *environment*, not just the trip length, that drives the rating. **Celestial dust** drops to yellow: Mars is red because a thin atmosphere whips fine, perchlorate-laden regolith into global dust storms that force their way into every seal and lung, while Ceres has essentially no atmosphere, so its dust is only mechanically disturbed during EVA (lunar-like, abrasive but not stormed into everything) [8]. **Dynamic loads** drop to yellow: landing on and departing a ~0.03 g body is nearly a docking maneuver, far gentler than Mars's atmospheric entry, descent, and landing, so the destination-side loads on the crew are lower even though the Earth-launch loads are unchanged [8].

**(b) Three areas in depth.**

**1. Radiation Carcinogenesis (Mars G/Y, Ceres R/R).** The biggest jump. Mars keeps in-mission dose within limits; a multi-year Ceres cruise blows past career limits, which is why conference judges argued nobody could survive the trip [3], [8]. *Mitigation:* use Ceres itself, a water-ice-rich body, to shield with mass you did not launch: bank water and regolith around a storm-shelter sleep station, bury the surface habitat, add radioprotectants and strict dosimetry, and shorten the transit to cut integrated dose.
...
**The breakdowns.** On 13 April 1970, oxygen tank 2 exploded during a routine cryogenic stir [9]:

- **A latent documentation/design disconnect:** the tank's heater used thermostatic switches still rated for the old 28 V ground supply, never updated when the command module went to 65 V. On a pre-flight detank the switches welded shut and the heater cooked the Teflon insulation off the fan wiring, and nobody caught it [9].
- **A routine action triggered it:** the standard stir energized the fan, the exposed wiring arced, the insulation ignited in the pure-oxygen tank, and the tank blew, also taking out a line to tank 1 [9].
- **Cascading loss:** both O2 tanks vented and two of three fuel cells died, so the CM lost most of its power, water, and oxygen, and the goal collapsed to "get everyone home alive" [9].
- **A hardware mismatch under stress:** in the lunar module (LM) lifeboat, the CM's square lithium-hydroxide canisters would not fit the LM's round CO2 receptacles, so ground engineers improvised the "mailbox" adapter and read it up to the crew [9].

**SHELL elements.** [3]. **Figure 2** is the model I reuse in Problem 9.
...
**(a) Moon.** Unique: 1/6 g, hard vacuum, a 14-day day/night cycle from ~+120 to below -130 C, and abrasive charged regolith that chewed through Apollo suit joints in three days [10].
...
**(b) Mars.** Unique: 0.38 g, a thin ~0.6 kPa CO2 atmosphere (near-vacuum, slight convection), global dust storms, toxic perchlorate fines, and -125 to +20 C, over hundreds of EVAs with no resupply [11].
...
**(c) Ceres.** Unique: ~0.03 g (an orbital EVA even while "standing"), 2.77 AU so very cold and dim, near-vacuum, and high cumulative radiation [3], [8].
...
~300 kg exercise, ~400 kg medical, ~800 kg radiation shielding = 1,500 kg.
...
Challenger (1986) and Columbia (2003) are the same organization making the same mistake seventeen years apart.[3].

**Table 5:** SHELL comparison of Challenger and Columbia.

| SHELL interface | Challenger (STS-51-L) | Columbia (STS-107) |
|:---|:---|:---|
| Hardware (H) | Cold-stiffened O-ring failed to seal, letting hot gas burn through [12] | Tank foam breached the wing's reinforced-carbon-carbon thermal protection [13] |
| Software (S) = procedures | Prior O-ring erosion accepted via waivers instead of grounding the fleet [12] | Foam shedding reclassified as an accepted "in-family" event [13] |
| Environment (E) | Record-cold launch below the O-ring's qualified range [12] | Entry heating, with no on-orbit inspection or rescue planned [13] |
| Liveware-Liveware (L-L) | Management overrode engineers who advised against launching cold [12] | Management dismissed engineers' requests for wing imaging [13] |
| Liveware (L) = crew | No survivable abort at that flight phase | No way to inspect or repair the wing from orbit |

**Common failure mode.** Both are normalization of deviance: an anomaly recurs without immediate consequence, so it gets quietly reclassified as acceptable until it kills a crew [12], [13]. In SHELL terms the fatal seam is Liveware-Liveware, engineering versus management. Behind both sat schedule and budget pressure and a safety function without the independent authority to stop the launch, so the S interface (the rules meant to catch these) had been eroded by the culture that wrote the waivers [12], [13]. The design deficiencies and operational decisions are in Table 5: a joint that leaked cold and a launch anyway; a debris-shedding tank with no inspection option and a waved-off imaging request.
...
[6] Schwalfenberg, G. K., "Vitamins K1 and K2: The Emerging Group of Vitamins Required for Human Health," *Journal of Nutrition and Metabolism*, Vol. 2017, Article 6254836, 2017. https://doi.org/10.1155/2017/6254836 [retrieved 10 July 2026].

[7] Celentano, J. T., Amorelli, D., and Freeman, G. G., "Establishing a Habitability Index for Space Stations and Planetary Bases," AIAA Paper 63-139, 1963.

[8] NASA Science, "Ceres: Facts," NASA Solar System Exploration, https://science.nasa.gov/dwarf-planets/ceres/facts/ [retrieved 6 July 2026].

[9] Cortright, E. M. (chair), "Report of the Apollo 13 Review Board," NASA, Washington, DC, 15 June 1970.

[10] Williams, D. R., "Moon Fact Sheet," NASA Goddard Space Flight Center / NSSDCA, https://nssdc.gsfc.nasa.gov/planetary/factsheet/moonfact.html [retrieved 6 July 2026].

[11] Williams, D. R., "Mars Fact Sheet," NASA Goddard Space Flight Center / NSSDCA, https://nssdc.gsfc.nasa.gov/planetary/factsheet/marsfact.html [retrieved 6 July 2026].

[12] Rogers, W. P. (chair), "Report of the Presidential Commission on the Space Shuttle Challenger Accident," U.S. Government Printing Office, Washington, DC, 6 June 1986.

[13] Columbia Accident Investigation Board, "Columbia Accident Investigation Board Report, Volume I," NASA and U.S. Government Printing Office, Washington, DC, Aug. 2003.

---

## Appendix

The three figures were generated with matplotlib

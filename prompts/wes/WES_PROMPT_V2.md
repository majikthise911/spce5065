<!-- WES_PROMPT v2.0 — Weekly Study Guide with 30k Overview -->
...
The output has TWO parts: a **30,000-Foot Overview** followed by the **full WES guide**. Both go in the same `.md` file.

---

## PART 1: 30,000-Foot Overview

This section goes FIRST in the file, before the WES content. Its purpose is to give the reader an accessible, plain-language understanding of what the week's assignment is really about before diving into the technical details.
...
**[Single big question in plain language]**

**Problem 1 — [Short Name].** [2-3 sentence explanation...]

**Problem 2 — [Short Name].** [2-3 sentence explanation...]

[...repeat for each problem...]

**The thread:** [Short paragraph connecting the problems and stating the takeaway.]

**How They Connect:**
[Table or prose linking this week to prior assignments/exams.]
```

After the 30k overview, insert a `---` separator before the WES content.

---

## PART 2: WES Guide

*Generated from: WES_PROMPT v2.0 | Model: [model name/version used] | Date: [YYYY-MM-DD]*
...
**Print-friendly mode (default):** Do NOT include Python code in the output. Instead, provide a 2-3 sentence description of what the visualization would show and reference the relevant homework solution script for generating the plot.

*If the topic benefits from a plot, describe it like this:*
> **Visualization:** [Description of what the plot shows and the physical insight it provides]. Run `[script_name.py]` to generate.

*If the topic does not benefit from visualization:*
...
- [ ] 30k overview is present at the top of the file, before the WES content
- [ ] 30k overview uses conversational tone and plain language
- [ ] 30k overview includes "The thread" and "How They Connect" (if applicable)
...
**Output ONLY the complete markdown file (30k overview + WES guide). No preamble or meta-commentary.**

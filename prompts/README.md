...
1. Point Claude at `1_solution_prompt_v9.4.md` → produces the submission.
...
| `1_solution_prompt_v9.4.md` | Produces a submission-ready homework paper + optional runnable code | 1 — first pass |

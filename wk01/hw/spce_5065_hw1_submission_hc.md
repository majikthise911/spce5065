...
**Date:** June 25, 2026
*Hand-calculated version — the quantitative work (Q2, Q6, Q7, Q8) is shown as my handwritten solutions in place of typeset math. Prose, figures, and tables are unchanged.*
...
![Q2(a) hand calculation — centripetal acceleration](hand_calcs/2a.png)
...
![Q2(b) hand calculation — orbital velocity](hand_calcs/2b.png)
...
![Q2(d) hand calculation — orbital period](hand_calcs/2c.png)
...
![Q6(a) hand calculation — S as a function of eccentricity](hand_calcs/6a.png)
...
![Q6(b) hand calculation — Earth's max and min irradiance](hand_calcs/6b.png)
...
For a small moon around a big planet, Kepler III is $T^2 = \dfrac{4\pi^2 a^3}{G M}$, which I invert for the central mass. Working in SI ($T = 14.1 \times 86400 = 1{,}218{,}240$ s, $a = 1.110781765\times10^9$ m, $G = 6.674\times10^{-11}$), and then comparing against the NASA Saturn Fact Sheet value of $5.6834\times10^{26}$ kg [9]:

![Q7(a,b) hand calculation — Saturn mass and percent difference](hand_calcs/7ab.png)
...
![Q8 hand calculation — asteroid mass from vis-viva](hand_calcs/8.png)
...
| File | Purpose |
|:---|:---|
| `spce_5065_hw1_submission_hc.md` | This document (hand-calculated version) |
| `hand_calcs/` | Handwritten solution images for Q2, Q6, Q7, Q8 |
